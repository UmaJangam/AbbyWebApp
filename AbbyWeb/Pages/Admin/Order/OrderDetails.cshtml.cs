    ...
    public class OrderDetailsModel : PageModel
    {
        ...
        public void OnGet(int id)
        {
            OrderDetailVM = new()
            {
                ...
                OrderDetail = _unitOfWork.OrderDetail.GetAll(u => u.OrderId == id).ToList()
            };
        }
        ...
        public IActionResult OnPostOrderRefund(int orderId)
        {
            ...
            Refund refund = service.Create(options);  //refurnd the complete amount here we can metion if it is complete refund or partial one
